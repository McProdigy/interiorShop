...
SECRET_KEY = 'django-insecure-4yt4=yihpa$8564^%$_da3n6ll0*feg@$&e^*v%ezqk@ompp1c'
...
LOGIN_URL = 'login'
LOGIN_REDIRECT_URL = 'vendor_app:vendor_admin'
LOGOUT_REDIRECT_URL = 'core_app:frontpage'
...
EMAIL_HOST_PASSWORD = 'jdgiagieigsgege'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
